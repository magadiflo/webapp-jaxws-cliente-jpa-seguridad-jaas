 ...
 * 
 */
@WebServiceClient(name = "CursoServicioWsImplService", targetNamespace = "http://services.jaxws.webapp.magadiflo.org/", wsdlLocation = "http://localhost:8080/81.webapp-jaxws-jpa-seguridad-jaas/CursoServicioWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CURSOSERVICIOWSIMPLSERVICE_QNAME = new QName("http://services.jaxws.webapp.magadiflo.org/", "CursoServicioWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/81.webapp-jaxws-jpa-seguridad-jaas/CursoServicioWsImpl?wsdl");
    ...
    public CursoServicioWs getCursoServicioWsImplPort() {
        return super.getPort(new QName("http://services.jaxws.webapp.magadiflo.org/", "CursoServicioWsImplPort"), CursoServicioWs.class);
    }
    ...
    public CursoServicioWs getCursoServicioWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.jaxws.webapp.magadiflo.org/", "CursoServicioWsImplPort"), CursoServicioWs.class, features);
    }
