 ...
 * generated in the org.magadiflo.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Guardar_QNAME = new QName("http://services.jaxws.webapp.magadiflo.org/", "guardar");
    private final static QName _GuardarResponse_QNAME = new QName("http://services.jaxws.webapp.magadiflo.org/", "guardarResponse");
    private final static QName _Listar_QNAME = new QName("http://services.jaxws.webapp.magadiflo.org/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.magadiflo.org/", "listarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.magadiflo.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.magadiflo.org/", name = "guardar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.magadiflo.org/", name = "guardarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.magadiflo.org/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.magadiflo.org/", name = "listarResponse")
