 ...
 * 
 */
@WebService(name = "CursoServicioWs", targetNamespace = "http://services.jaxws.webapp.magadiflo.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CursoServicioWs {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "guardar", targetNamespace = "http://services.jaxws.webapp.magadiflo.org/", className = "org.magadiflo.webapp.jaxws.services.Guardar")
    @ResponseWrapper(localName = "guardarResponse", targetNamespace = "http://services.jaxws.webapp.magadiflo.org/", className = "org.magadiflo.webapp.jaxws.services.GuardarResponse")
